...
window.addEventListener("onEventReceived", async function (obj) {
    if (obj.detail.event.listener === "widget-button") return;
 ...
 * @param {string} msgId
 */
function addMessage(nickname, username, badges, message, isAction, userId, msgId) {
    if (noname === "show") {
...
function animateMessage(element, messageIndex) {
    $('.main-container').prepend(element);
    gsap.fromTo(`#msg-${messageIndex}`, 0.5, { width: 0 }, { ease: Power1.easeOut, width: "auto" });
